...
FIGURES = {
    "fig01": "fig01_study_domains.svg",
    "fig02a": "fig02_extent_hit_miss_carlisle_E1.svg",
    "fig02b": "fig02_extent_hit_miss_chowilla_E1.svg",
    "fig02c": "fig02_extent_hit_miss_burnett_E1.svg",
    "fig03a": "fig03_peak_depth_error_carlisle_E1.svg",
    "fig03b": "fig03_peak_depth_error_chowilla_E1.svg",
    "fig03c": "fig03_peak_depth_error_burnett_E1.svg",
    "fig04a": "fig04_pwet_carlisle_E1.svg",
    "fig04b": "fig04_pwet_chowilla_E1.svg",
    "fig04c": "fig04_pwet_burnett_E1.svg",
    "fig05": "fig05_cross_case_csi_rmse_wet_train.svg",
    "fig06": "fig06_error_budget_o1o4.svg",
    "fig07": "fig07_global_vs_hlsg_ab.svg",
    "fig08": "fig08_uq_calibration_crps_scale.svg",
    "fig09": "fig09_zoning_wet_correlation_ab.svg",
}
...
def main() -> None:
    ...
    def cap_dim(d: dict | None, fallback: str = "n/a") -> str:
        if not d:
            return fallback
        try:
...
"""
    ...
    fig_specs = [
        ...
        (
            ...
            f"湿 CSI≈{r4(metrics['chow_h_wet_csi'])}，all-cells≈{r4(metrics['chow_h_all_csi'])}。",
            "EXT 学习域=训练湿类别。",
        ...
        (
            ...
            "读法同 2a；对比左右红/金面积。",
            "LF 更多漏检/虚警；LSG 蓝区扩大。",
            f"CSI {r4(metrics['burn_lf_wet_csi'])}→{r4(metrics['burn_h_wet_csi'])}。",
            "LF 几何粗 → 映射可学订正。",
        ...
        (
            ...
            "读法同 3a。",
            "LF 大幅红/蓝；LSG 变浅。",
            f"湿 RMSE LSG≈{r3(metrics['chow_h_wet_rmse'])} m。",
            "WSE+EXT。",
        ...
        (
            ...
            "读法同 3a。",
            "左深红；右近白。",
            f"RMSE {r3(metrics['burn_lf_wet_rmse'])}→{r3(metrics['burn_h_wet_rmse'])} m。",
            "多保真映射。",
        ...
        (
            ...
            "横轴案例，纵轴 CSI/RMSE。",
            "Burnett 抬升最大。",
            f"Burnett CSI {r4(metrics['burn_lf_wet_csi'])}→{r4(metrics['burn_h_wet_csi'])}。",
            "弱 LF → 映射可学。",
        ...
        (
            ...
            "O1–O4 RMSE。",
            "按案例分面。",
            f"Carlisle Max O2−O1≈{r3(car_max_eb.get('o2_minus_o1'))}。",
            "神谕阶梯。",
            "可以：定位误差。不可以：O4=无能。",
            "像体检分项。",
        ),
        (
            ...
            "CSI/RMSE 并排。",
            "湿 CSI 接近；O2−O1 更小。",
            f"Chowilla H-LSG {r4(metrics['chow_h_wet_csi'])} vs global {r4(metrics['chow_g_wet_csi'])}。",
            "残差基压缩截断。",
        ...
        (
            ...
            f"Carlisle CRPS {r3(crps_max_before)}→{r3(crps_max_after)}。",
            "标量 s。",
            "不可以：声称三案例均成功。",
            "像把±10°C 改口±4°C。",
        ),
        (
            ...
            "CSI/RMSE 柱。",
            "边际差很小。",
            f"wet CSI：global {r4(metrics['chow_g_wet_csi'])}；H-LSG {r4(metrics['chow_h_wet_csi'])}；wet_correlation {r4(metrics['chow_wc_wet_csi'])}。",
            "相关分区改变残差聚合。",
            "可以：单折敏感性。不可以：宣称全面更优。",
            "像换行政区划重画修正层。",
        ),
